...
const AboutSection: React.FC = () => {
  return (
    <section className="w-full  py-12 px-4" style={{
    ...
    <div className="mt-[-40px] bg-white rounded-xl shadow-lg px-8 py-6 w-[400px] text-center relative z-10">
      ...
      <p className="text-gray-700 text-lg font-medium">
        ...
        <div className="flex-1 mt-20 md:mt-0 md:w-1/2 flex flex-col justify-center">
          <h2 className="text-[#CBB26A] text-3xl md:text-4xl font-bold mb-6">
            About Dr. Gunjan Agarwal
          </h2>
          <p className="text-white text-lg md:text-xl mb-10 leading-relaxed">
          Dr. Gunjan Agarwal is a renowned Life Coach and the visionary force behind Brahmavastu.g1, known for empowering thousands to transform their lives through the combined wisdom of Vastu, ancient sciences, and modern positive psychology.
          <br />
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 bg-[#181e34] rounded-xl border border-[#CBB26A] px-6 py-6 text-center">
              <span className="block text-2xl md:text-3xl font-bold text-white mb-1">10+</span>
              <span className="text-[#CBB26A] text-base md:text-lg font-medium">Countries Served</span>
            </div>
            <div className="flex-1 bg-[#181e34] rounded-xl border border-[#CBB26A] px-6 py-6 text-center">
              <span className="block text-2xl md:text-3xl font-bold text-white mb-1">2 Lakh+</span>
              <span className="text-[#CBB26A] text-base md:text-lg font-medium">Students</span>
            </div>
            <div className="flex-1 bg-[#181e34] rounded-xl border border-[#CBB26A] px-6 py-6 text-center">
              <span className="block text-2xl md:text-3xl font-bold text-white mb-1">5 Lakh+</span>
              <span className="text-[#CBB26A] text-base md:text-lg font-medium">Kundli’s Made</span>
            </div>
          </div>
        </div>
      </div>
